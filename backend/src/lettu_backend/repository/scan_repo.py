...
from lettu_backend.models.database import AIConditionScan, AIProduceScan, SystemConfig, InternalEnvironmentReading
...
class DataRepository:
    ...
    # --- SENSOR METHODS (now consolidated into InternalEnvironmentReading) ---
